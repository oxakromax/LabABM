...
import EDU.gatech.cc.is.abstractrobot.KinSensorSim;
import EDU.gatech.cc.is.abstractrobot.Simple;
import EDU.gatech.cc.is.abstractrobot.TransceiverSim;
...
public class NetNodeSim extends Simple
    ...
    private final Point last = new Point(0, 0);
    private final long last_Obstaclest = 0;
    private final long last_VisualObjectst = 0;
    private final int num_VisualObjects = 0;
    private final int last_channel = 0;
    private final long last_VisualSizest = 0;
    private final boolean in_reverse = false;
