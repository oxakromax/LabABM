...
public abstract class Gaussian {
    ...
    public void setMean(int i, double mn) {
        mean[i] = mn;
    } //set the mean for var i

    public void setDev(int i, double dv) {
        dev[i] = dv;
    } //set the standard deviation for var i

    public double getMean(int i) {
        return mean[i];
    }

    public double getDev(int i) {
        return dev[i];
    }
