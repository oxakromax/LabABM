...
import EDU.cmu.cs.coral.util.Heap;
import EDU.cmu.cs.coral.util.PriorityQueue;
import EDU.cmu.cs.coral.util.UnexpectedException;
import EDU.gatech.cc.is.learning.i_ReinforcementLearner_id;
...
public class i_PriQLearner_id extends i_ReinforcementLearner_id
	...
	private final int[] last_policy;          // used to count changes in
	// policy
	...
	private final Random rgen;                   // the random number generator
	private int xn;                     // last state
	private int an;                     // last action
	private long seed = 0;            // random number seed
	private static final boolean DEBUG = false;
	private final int updateCount = 50;
	private final double minUpdate = 1e-4;
...
*/
	...
	/**
	 vate final class stateComparator implements Comparator {
	 public int compare(Object o1, Object o2) {
	 if (!(o1 instanceof state e1))
	 return 0;
	 if (!(o2 instanceof state e2))
	 return 0;
