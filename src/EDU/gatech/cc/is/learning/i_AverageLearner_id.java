...
public class i_AverageLearner_id extends i_ReinforcementLearner_id
    ...
    private final double[][] q;                  // the q-values
    private final double[][] p;                  // count of times in each
    // state/action
    private final int[] last_policy;          // used to count changes in
    private final double gamma = 0.8;              // discount rate
    private final Random rgen;                   // the random number generator
    private final long seed = 0;            // random number seed
    // policy
