...
import EDU.gatech.cc.is.newton.Newton;
import EDU.gatech.cc.is.newton.NewtonTrans;
...
public class MultiForageN150Hard extends SimpleN150Hard
    ...
    private final long last_ObjectInGrippert = 0;
        ...
        if (keep_running) {
            ...
            if (bumps != 240) {
                ...
                if (bumps == 65776)
                    ...
                    tmpvec.sett(Units.DegToRad(18));
                else if (bumps == 524528)
                    tmpvec.sett(Units.DegToRad(18 + 36));
