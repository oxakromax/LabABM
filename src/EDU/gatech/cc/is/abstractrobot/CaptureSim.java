...
public class CaptureSim extends Simple
        implements Capture, SimpleN150, SimulatedObject {
    public static final boolean DEBUG = false;
    private final long last_VisualSizest = 0;
    private final long last_VisualAxest = 0;
    ...
    /**
     * Instantiate a <B>CaptureSim</B> object.  Be sure
    ...
    public CaptureSim() {
        ...
        if (DEBUG) System.out.println("CaptureSim: instantiated.");
    ...
    /**
     * Initialize a <B>CaptureSim</B> object.
     */
    public void init(double xp, double yp, double tp, double ignore,
        ...
        timed = 0;
        visionclass = v;
        if (DEBUG) System.out.println("CaptureSim: initialized"
                + " at " + xp + "," + yp);
    }
    ...
    public void takeStep(long time_increment, SimulatedObject[] all_objs) {
        if (DEBUG) System.out.println("CaptureSim.TakeStep()");
    ...
    public boolean checkCollision(Circle2 c) {
        ...
        // closest point is within c.radius of c.centre
        return closest.r <= c.radius;
    }
    ...
    public void draw(Graphics g, int w, int h,
        ...
        int visionr = (int) (Capture.VISION_RANGE / meterspp);
        int xpix = (int) ((position.x - l) / meterspp);
        int ypix = (int) ((double) h - ((position.y - b) / meterspp));
        ...
        // don't draw the vision arc for capture agents
