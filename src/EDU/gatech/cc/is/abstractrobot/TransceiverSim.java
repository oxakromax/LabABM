...
public class TransceiverSim {
    ...
    private final SimulatedObject robotsim;    // the simulated parts
    private final Simple robot;        // the robot parts
    private final CircularBuffer messages =    // the buffer where
