...
public class Newton {
     ...
     * @throws Exception If unable to make native code resident.
     */
     ...
     *
     * @throws Exception If unable to release code resources.
     * @throws Throwable If super.finalize() throws it.
     */
