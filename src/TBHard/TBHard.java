...
import EDU.cmu.cs.coral.abstractrobot.ControlSystemCye;
import EDU.cmu.cs.coral.abstractrobot.SimpleCyeHard;
import EDU.gatech.cc.is.abstractrobot.ControlSystemMFN150;
import EDU.gatech.cc.is.abstractrobot.ControlSystemS;
import EDU.gatech.cc.is.abstractrobot.MultiForageN150HardPassiveGrip;
...
public class TBHard {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (robotType.equals("N")) {
                abstract_robot.setBaseSpeed(((MultiForageN150HardPassiveGrip) abstract_robot).MAX_TRANSLATION);
                ...
                abstract_robot.setBaseSpeed(((SimpleCyeHard) abstract_robot).MAX_TRANSLATION);
                abstract_robot.resetPosition(new Vec2(startx, starty));
